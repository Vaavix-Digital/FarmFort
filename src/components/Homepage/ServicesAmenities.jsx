  ...
  return (
    <section className="w-full py-16 px-4 md:px-8 lg:px-16" style={{ backgroundColor: '#0F4D2F' }}>
      <div className="max-w-7xl mx-auto text-center">
        {/* Logo Icon */}
        <div className="mb-4">
          <div className="w-16 h-16 rounded-full flex items-center justify-center mx-auto overflow-hidden bg-white p-1">
            <img 
              src="/logo icon.png" 
              alt="Resort Logo"
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 mx-auto max-w-6xl" style={{
          ...
          {amenities.map((item, index) => (
            ...
            >
              ...
              {/* Label */}
              <p className="text-gray-800 text-xl font-medium group-hover:text-white text-center font-gilda">
                {item.name}
              </p>
            </div>
          ))}
